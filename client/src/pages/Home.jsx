...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f3f3] dark:bg-gray-900 flex flex-col">
      <Navbar />
            ...
            {steps.map((item, index) => (
              <motion.div
                ...
                className={`
                  ...
                  rounded-3xl
                  border-2 border-green-100 dark:border-gray-700
                ...
                `}
              >
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white dark:bg-gray-900 border-2
                 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg">
                  {item.icon}
                </div>
                ...
                <div className="pt-10 text-center">
                  ...
                  <h3 className="font-semibold mb-3 text-lg text-black dark:text-white">{item.title}</h3>
